...
public class FirstTest {
    ...
    @Test
    public void Test1() throws java.awt.datatransfer.UnsupportedFlavorException, java.io.IOException {
        driver.get("https://clipboardjs.com/");

        WebElement copyButton = driver.findElement(By.xpath("//div[@id='example-target']" +
                "/div[@class='input-group']/span[@class='input-group-button']/button[@class='btn']"));
        copyButton.click();
